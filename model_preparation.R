...
for (e in .endpoints){# generate event status, stop time and duration
  ...
  if (e=="cancer") cut <- "2020-12-31" else cut <- "2020-12-31" # RW: try to extend it to the latest CRV record "2017-03-31" 
...
# add a 3-group age
d4s$age3 <- ifelse(d4s$age.recruit<50, "<50", 
                   ifelse(d4s$age.recruit %in% 50:59, "50-59", "60+")) 
